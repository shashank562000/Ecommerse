...
} elseif ($_instance->childHasBeenRendered('0GTtE3w')) {
    $componentId = $_instance->getRenderedChildComponentId('0GTtE3w');
    $componentTag = $_instance->getRenderedChildComponentTagName('0GTtE3w');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0GTtE3w');
} else {
    $response = \Livewire\Livewire::mount('search-dropdown', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('0GTtE3w', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
} elseif ($_instance->childHasBeenRendered('Pk7pmtr')) {
    $componentId = $_instance->getRenderedChildComponentId('Pk7pmtr');
    $componentTag = $_instance->getRenderedChildComponentTagName('Pk7pmtr');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Pk7pmtr');
} else {
    $response = \Livewire\Livewire::mount('nav-bar', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('Pk7pmtr', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
	</header>
...
} elseif ($_instance->childHasBeenRendered('dPWysUZ')) {
    $componentId = $_instance->getRenderedChildComponentId('dPWysUZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('dPWysUZ');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dPWysUZ');
} else {
    $response = \Livewire\Livewire::mount('footer-detail', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('dPWysUZ', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
	<!-- Footer section end -->
...
<?php /**PATH E:\Task\Ecomerce\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>