...
} elseif ($_instance->childHasBeenRendered('otaRm8b')) {
    $componentId = $_instance->getRenderedChildComponentId('otaRm8b');
    $componentTag = $_instance->getRenderedChildComponentTagName('otaRm8b');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('otaRm8b');
} else {
    $response = \Livewire\Livewire::mount('admin.search-bar', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('otaRm8b', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Task\Ecomerce\resources\views/admin/products/index.blade.php ENDPATH**/ ?>