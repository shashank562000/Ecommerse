...
<title>
	<?php if(auth()->check()): ?> 
		<?php echo e(auth()->user()->name); ?> 's Cart
	<?php else: ?>
		Cart
	<?php endif; ?>
</title>
			...
			<div class="col-lg-8">
				<div class="cart-table">
					...
					<div class="total-cost">
						<h6>Total <span><?php echo e($newTotal); ?></span></h6>
					</div>
				</div>
			</div>
			<div class="col-lg-4 card-right">
				<?php if(! session()->has('coupon')): ?>
				<form action="<?php echo e(route('coupons.store')); ?>" class="promo-code-form" method="post">
					<?php echo csrf_field(); ?>
					<input type="text" name="coupon_code" id="coupon_code" placeholder="Enter promo code">
					<button type="submit">Submit</button>
				</form>
				<?php endif; ?>
				<a href="<?php echo e(route('checkout.index')); ?>" class="site-btn">Proceed to checkout</a>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Task\Ecomerce\resources\views/cart.blade.php ENDPATH**/ ?>